 ...
 */
class SharedPolyPanelComponent extends HTMLElement {
...
customElements.define("x-pp-shared", SharedPolyPanelComponent);

class PolyPanelFrame extends HTMLElement {
    static observedAttributes = ["default", "pid", "shared"];
    /**@type {Record<string,SharedPolyPanelComponent>} */
    #replaced = {};
    /**@type {PolyPanel} */
    #parent;
    constructor() {
     ...
     */
    _releaseShared() {
        if (!this.#parent.getShared()) return;
        /**@type {SharedPolyPanelComponent[]} */
        const shared = [];
    ...
    _aquireShared() {
        ...
        this.querySelectorAll("x-pp-shared:not([definition])").forEach(/**@param {SharedPolyPanelComponent} v*/v => {
            /**@type {SharedPolyPanelComponent} */
...
customElements.define("x-pp-panel", PolyPanelFrame);

class PolyPanel extends HTMLElement {
